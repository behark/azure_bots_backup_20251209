#!/usr/bin/env python3
"""Analyze historical Liquidation Bot signals from log files."""
...
def main():
    ...
    # Find log file
    base_dir = Path(__file__).parent / "liquidation_bot" / "logs"
    log_file = base_dir / "liquidation_bot.log"
    ...
    if stats:
        print_report(stats, "Liquidation Bot")
